...
function ChatComponent({ inputEnable, setInputEnable, activedPlugin, setActivedPlugin, selectedLanguage }: ChatComponentProps) {
    ...
    // ========================== REMOVE TYPING EFFECT =======================================
            ...
            //             { text: currentMessage, files: [], images: [], sender: 'bot' },
            //         ]);
            //         index++;
    ...
    // console.log("Language Data:", languageData); // Debugging
    ...
    // useEffect(() => {
    //     console.log("Language changed in ChatComponent:", selectedLanguage);
    // }, [selectedLanguage]);
    ...
    // // Plugin não ativo: fetch dos plugins
    // useEffect(() => {
    //     if (!activedPlugin) {
    //         fetchPlugins();
    //     }
    ...
    // This creates socket error and displays various messages
    // useEffect(() => {
    //     let counter = 0;
